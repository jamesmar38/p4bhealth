...
if (isset($config))
{
  ...
  $base_host                         = $_SERVER['HTTP_HOST'];
    ...
    1 => array(
      ...
      'server_path' => $images_path . '/uploads/home/',
      'url'         => $images_url  . '/uploads/home/'
    ),
    2 => array(
      'name'        => 'people images',
      'server_path' => $images_path . '/uploads/people-img/',
      'url'         => $images_url  . '/uploads/people-img/'
    ),
    3 => array(
      'name'        => 'general',
      'server_path' => $images_path . '/uploads/general/',
      'url'         => $images_url  . '/uploads/general/'
      )
  );
	 ...
	 */
  // $env_config['nsm_htaccess_generator_path'] => $base_path;
  $config['ce_cache_secret'] = 'nt2GChni2tu54B';
  $config['ce_cache_drivers'] = 'memcached|file|db';
  $env_config['ce_image_document_root'] = $base_path;
  $env_config['ce_image_memory_limit'] = 128; 
  ...
  $env_config['smtp_server']              = 'smtp.sendgrid.net';
  $env_config['smtp_username']            = 'mtrubidouxsda';
  $env_config['smtp_password']            = 'Z3iq4LDC2kmE';
