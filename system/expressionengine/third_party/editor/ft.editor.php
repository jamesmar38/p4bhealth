...
class Editor_ft extends EE_Fieldtype
{
	...
	public function display_field($data)
	{
		...
		//----------------------------------------
		$this->EE->editor_helper->mcp_js_css('gjs');
        $this->EE->editor_helper->mcp_js_css('css', 'redactor/redactor.css?v='.EDITOR_VERSION, 'redactor', 'main');
        $this->EE->editor_helper->mcp_js_css('css', 'editor.css?v='.EDITOR_VERSION, 'editor', 'main');

        if ($this->EE->input->ip_address() == '127.0.0.1') $this->EE->editor_helper->mcp_js_css('js', 'redactor/redactor.js?v='.EDITOR_VERSION, 'redactor', 'main');
        else $this->EE->editor_helper->mcp_js_css('js', 'redactor/redactor.min.js?v='.EDITOR_VERSION, 'redactor', 'main');

        $this->EE->editor_helper->mcp_js_css('js', 'editor_helper.js?v='.EDITOR_VERSION, 'editor', 'helper');
        $this->EE->editor_helper->mcp_js_css('js', 'editor_buttons.js?v='.EDITOR_VERSION, 'editor', 'buttons');

		// Do we need to load an additional Language?
		if (isset($settings['language']) === TRUE && $settings['language'] != 'en')
		{
			$this->EE->editor_helper->mcp_js_css('js', 'redactor/lang/'.$settings['language'].'.js?v='.EDITOR_VERSION, 'redactor', 'lang');
		}
	...
	private function _display_settings($settings=array())
	{
		...
		$this->EE->editor_helper->mcp_js_css('gjs');
        $this->EE->editor_helper->mcp_js_css('css', 'redactor/redactor.css?v='.EDITOR_VERSION, 'redactor', 'main');
        $this->EE->editor_helper->mcp_js_css('css', 'global.css?v='.EDITOR_VERSION, 'editor', 'global');
        $this->EE->editor_helper->mcp_js_css('js', 'editor_settings.js?v='.EDITOR_VERSION, 'editor', 'settings');
		...
		// URL
		$data['act_url'] = $this->EE->editor_helper->get_router_url('url', 'ACT_file_upload');
	...
	public function display_cell($data)
	{
        ...
        $this->EE->editor_helper->mcp_js_css('css', 'redactor/redactor.css?v='.EDITOR_VERSION, 'redactor', 'main');
        $this->EE->editor_helper->mcp_js_css('css', 'editor.css?v='.EDITOR_VERSION, 'editor', 'main');
        $this->EE->editor_helper->mcp_js_css('js', 'redactor/redactor.min.js?v='.EDITOR_VERSION, 'redactor', 'main');
        $this->EE->editor_helper->mcp_js_css('js', 'editor_helper.js?v='.EDITOR_VERSION, 'editor', 'helper');
        $this->EE->editor_helper->mcp_js_css('js', 'editor_buttons.js?v='.EDITOR_VERSION, 'editor', 'buttons');
