...
class Editor_ext
{
	...
	public function __construct()
	{
		...
		$this->EE->editor_helper->get_theme_url();
	...
	public function cp_js_end()
	{
		...
		{
			$lang_js = "document.write('<script type=\"text/javascript\" src=\"".EDITOR_THEME_URL."redactor/lang/{$settings['language']}.js?v=".EDITOR_VERSION."\"></script>');";
		}
		...
		if (/D=cp&C=admin_content&M=category_edit/.test(document.location.href) && document.getElementById('cat_description')) {
			...
			if (typeof(EditorButtons) == 'undefined') {
				...
				jQuery('body').append('<link rel=\"stylesheet\" href=\"".EDITOR_THEME_URL."redactor/redactor.css?v=".EDITOR_VERSION."\" type=\"text/css\" />');
				jQuery('body').append('<link rel=\"stylesheet\" href=\"".EDITOR_THEME_URL."editor.css?v=".EDITOR_VERSION."\" type=\"text/css\" />');

				document.write('<script type=\"text/javascript\" src=\"".EDITOR_THEME_URL."editor_buttons.js?v=".EDITOR_VERSION."\"></script>');
				document.write('<script type=\"text/javascript\" src=\"".EDITOR_THEME_URL."redactor/redactor.min.js?v=".EDITOR_VERSION."\"></script>');
				document.write('<script type=\"text/javascript\" src=\"".EDITOR_THEME_URL."editor_helper.js?v=".EDITOR_VERSION."\"></script>');
				{$lang_js}
