...
class Social_login_pro {
    ...
    function form()
    {
        ...
        {
            $data['hidden_fields']['no_email_return'] = $this->EE->functions->fetch_site_index();
        }
...
myForm.onsubmit = function() {
    ...
    {        
        ...
        $response = $this->EE->$lib->get_request_token($access_token_url, $will_post);
    ...
    function access_token()
    {
        ...
        {
            $data['timezone'] = array_search($userdata['timezone'], $this->EE->localize->zones());
        }
        else
        {
